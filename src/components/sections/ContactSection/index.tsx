      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Fila: email + llamar izquierda, WhatsApp + Enviar derecha */}
            <div className="flex items-center justify-between pt-1 gap-4">
              <div className="flex items-center gap-4">
                <a href="mailto:miguel@soportec.eu" className="flex items-center gap-2 text-gray-800 dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400 transition-colors text-base md:text-xl font-bold whitespace-nowrap">
                  <svg className="w-5 h-5 md:w-6 md:h-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
