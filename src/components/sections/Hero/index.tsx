...
import heroVideo from '../../../assets/SOPORTEC.mp4'
      ...
      <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center gap-10 md:gap-16">
        ...
        >
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 dark:text-white mb-5 leading-tight">
            Tu informático de confianza en Valencia
          </h1>

          <p className="text-gray-600 dark:text-gray-400 mb-3 leading-relaxed">
            Bienvenido a SOPORTEC, tu aliado en soluciones tecnológicas en Valencia y alrededores.
          </p>

          <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
            Nos especializamos en brindar asistencia y mantenimiento informático tanto de manera presencial como remota para empresas, autónomos y particulares.
          </p>

          <p className="text-gray-700 dark:text-gray-300 font-medium mb-8">
            ¡Conócenos y descubre cómo podemos ayudarte!
          </p>

          <div className="flex flex-col gap-3 items-center">
            <a href="tel:+34628110705" className="btn-phone">
            ...
            <a
              ...
              className="btn-whatsapp inline-flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white font-semibold px-8 py-4 rounded-full text-lg"
            >
